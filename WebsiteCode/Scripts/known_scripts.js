...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
let finalDesc = document.querySelector('FinalDescBtn');

finalDesc.addEventListener('click', () =>{
    shuffle(ideas);
});
...
function hideShow() {
  ...
  function userPrompt() {
    ...
    finalIdea = finalIdeas[parseInt(index - 1)];
    document.querySelector('FDlist').innerHTML = finalIdea;
  }